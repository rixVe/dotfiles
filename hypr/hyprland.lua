...
hl.on("hyprland.start", function ()
  ...
  hl.exec_cmd("hyprctl setcursor volantes-light-cursors 36")
end )
hl.env("XCURSOR_SIZE", "36")
hl.env("HYPRCURSOR_SIZE", "36")
hl.env("XCURSOR_THEME","volantes-light-cursors")
hl.env("HYPRCURSOR_THEME","volantes-light-cursors")
...
hl.bind(mainMod .. " + SHIFT + CTRL + L", hl.dsp.exec_cmd("loginctl lock-session"))
hl.bind(mainMod .. " + N", hl.dsp.exec_cmd("sunsetr preset night"))
hl.bind(mainMod .. " + SHIFT + N", hl.dsp.exec_cmd("sunsetr preset halfnight"))
...
hl.bind("Print", hl.dsp.exec_cmd("gscreenshot"))
...
hl.bind(mainMod .. " + CTRL + SHIFT + F", hl.dsp.window.fullscreen_state({internal = 2, client = 0, action = "toggle"}))
